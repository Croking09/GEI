	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		http.cors(Customizer.withDefaults())
			...
			.authorizeHttpRequests((authorize) -> authorize
				...
				.requestMatchers(HttpMethod.GET, "/catalog/productos").permitAll()
				.requestMatchers(HttpMethod.GET, "/catalog/productos/*").permitAll()
				.requestMatchers(HttpMethod.POST, "/productos").hasRole("USER")
				.requestMatchers(HttpMethod.POST, "/pujas").hasRole("USER")
				.requestMatchers(HttpMethod.GET, "/pujas/user").hasRole("USER")
				.requestMatchers(HttpMethod.GET, "/productos/user").hasRole("USER")
				.anyRequest().denyAll());
